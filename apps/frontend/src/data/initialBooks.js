...
export const initialBooks = [
    ...
    { id: 16, title: 'Harry Potter and the Philosopher\'s Stone', author: 'J.K. Rowling', category: 'novel', cover: 'https://images.unsplash.com/photo-1544947950-fa07a98d237f?w=300&h=400&fit=crop', year: 1997, stock: 5 },
    { id: 17, title: 'The Hobbit', author: 'J.R.R. Tolkien', category: 'novel', cover: 'https://images.unsplash.com/photo-1629992101753-56d196c8aced?w=300&h=400&fit=crop', year: 1937, stock: 3 },
    { id: 18, title: 'Rich Dad Poor Dad', author: 'Robert Kiyosaki', category: 'motivation', cover: 'https://images.unsplash.com/photo-1592492159418-39f319320569?w=300&h=400&fit=crop', year: 1997, stock: 4 },
    { id: 19, title: 'Deep Work', author: 'Cal Newport', category: 'motivation', cover: 'https://images.unsplash.com/photo-1589829085413-56de8ae18c73?w=300&h=400&fit=crop', year: 2016, stock: 3 },
    { id: 20, title: 'Sapiens: A Brief History of Humankind', author: 'Yuval Noah Harari', category: 'history', cover: 'https://images.unsplash.com/photo-1589829085413-56de8ae18c73?w=300&h=400&fit=crop', year: 2011, stock: 2 },
    { id: 21, title: 'The 7 Habits of Highly Effective People', author: 'Stephen Covey', category: 'motivation', cover: 'https://images.unsplash.com/photo-1544947950-fa07a98d237f?w=300&h=400&fit=crop', year: 1989, stock: 6 },
    { id: 22, title: 'Thinking, Fast and Slow', author: 'Daniel Kahneman', category: 'motivation', cover: 'https://images.unsplash.com/photo-1512820790803-83ca734da794?w=300&h=400&fit=crop', year: 2011, stock: 3 },
    { id: 23, title: 'Man\'s Search for Meaning', author: 'Viktor Frankl', category: 'motivation', cover: 'https://images.unsplash.com/photo-1541963463532-d68292c34b19?w=300&h=400&fit=crop', year: 1946, stock: 4 },
    { id: 24, title: 'The Alchemist', author: 'Paulo Coelho', category: 'novel', cover: 'https://images.unsplash.com/photo-1544947950-fa07a98d237f?w=300&h=400&fit=crop', year: 1988, stock: 7 },
    { id: 25, title: 'Dune', author: 'Frank Herbert', category: 'novel', cover: 'https://images.unsplash.com/photo-1532012197267-da84d127e765?w=300&h=400&fit=crop', year: 1965, stock: 2 },
    { id: 26, title: '1984', author: 'George Orwell', category: 'novel', cover: 'https://images.unsplash.com/photo-1543004218-ee141104308d?w=300&h=400&fit=crop', year: 1949, stock: 5 },
    { id: 27, title: 'To Kill a Mockingbird', author: 'Harper Lee', category: 'novel', cover: 'https://images.unsplash.com/photo-1544947950-fa07a98d237f?w=300&h=400&fit=crop', year: 1960, stock: 3 },
    { id: 28, title: 'The Great Gatsby', author: 'F. Scott Fitzgerald', category: 'novel', cover: 'https://images.unsplash.com/photo-1512820790803-83ca734da794?w=300&h=400&fit=crop', year: 1925, stock: 4 },
    { id: 29, title: 'The Art of War', author: 'Sun Tzu', category: 'history', cover: 'https://images.unsplash.com/photo-1516321318423-f06f85e504b3?w=300&h=400&fit=crop', year: -500, stock: 10 },
    { id: 30, title: 'Start with Why', author: 'Simon Sinek', category: 'motivation', cover: 'https://images.unsplash.com/photo-1497633762265-9d179a990aa6?w=300&h=400&fit=crop', year: 2009, stock: 5 },
]
